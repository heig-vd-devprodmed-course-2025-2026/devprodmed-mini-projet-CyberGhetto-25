        ...
        <form method="POST" action="{{ url('/tokens') }}">
            ...
            <div class="mb-4">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}"
                    ...
                    class="w-full px-3 py-2 border rounded-md bg-white dark:bg-neutral-700 text-gray-900 dark:text-white focus:ring-2 focus:border-transparent @error('name') border-red-500 focus:ring-red-500 @else border-gray-300 dark:border-gray-600 focus:ring-amber-500 focus:ring-amber-500 @enderror">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <input id="expiration_date" type="date" name="expiration_date" value="{{ old('expiration_date') }}"
                    ...
                    class="w-full px-3 py-2 border rounded-md bg-white dark:bg-neutral-700 text-gray-900 dark:text-white focus:ring-2 focus:border-transparent @error('expiration_date') border-red-500 focus:ring-red-500 @else border-gray-300 dark:border-gray-600 focus:ring-amber-500 focus:ring-amber-500 @enderror">
